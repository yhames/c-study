#ifndef EXTREMEC_EXAMPLES_CHATPER_3_2_H
#define EXTREMEC_EXAMPLES_CHATPER_3_2_H
...
polar_pos_2d_t		convert_to_2d_polar_pos(const cartesian_pos_2d_t *cartesain_pos);
